...
export const Footer = () => {
  ...
  return (
    <div className="footer portfolio-section">
      <FooterLogoSVG />
      <p className="max-width text-center">If you've got this far maybe you'd like to know more about me? <br /> We should <motion.a whileHover={{ scale: 1.05 }} href="mailto:fanninggg@gmail.com" target="_blank">have a chat</motion.a></p>
